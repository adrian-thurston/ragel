...
#ifndef _AAPL_TAVLTREE_H
#define _AAPL_TAVLTREE_H
 ...
 *
 * TAvlTree is the standard by-structure AVL tree. A element class and a key type
 ...
 * the AvlTreeEl class.
 *
 * TAvlTree does not explicitly manage memory for element. Elements inserted into
...
#define BASECAST(name) static_cast<TAvlTreeEl*>(name)
#define SUPERCAST(name) static_cast<Element*>(name)
...
#define TAvlTree TAvlTree

#include "tavlcommon.h"
