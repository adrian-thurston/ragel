 ...
 * user. With the exception of DListVal the user typically goes
 *
 * list.append( new ElementType(...) );
 *
 * Elements can also have static allocation. For this reason, DList and DListMel
 * will not delete the list contents in their destructors.
 *
 ...
 *
 * A value oriented list DListVal that behaves much like the STL list class is
 * also provided.
 */
