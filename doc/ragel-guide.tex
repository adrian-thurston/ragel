...
\item \verb|p| - Data pointer. In C/C++/D code this variable is expected to be a
...
and OCaml it is used as an offset to \verb|data| and must be an integer. In this
...
input buffer the initial value of \verb|p|. A In Go, Java, Ruby and OCaml code this
